...
This template project has categorized directories like below:
  ...
  - [src/](src/): TypeScript Source directory
    - [src/api/](src/api/): SDK that would be published to the `@samchon/payments-backend-api`
...
After the account configuration, connect to the MariaDB and create a new DB schema `payments`. Also, you should change the `sql_mode` options like below to enhance the strict grammer check for the safe development. 
